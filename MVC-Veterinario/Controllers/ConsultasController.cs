...
namespace MVC_Veterinario.Controllers
{
    public class ConsultasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DataHora,Descricao,IdAnimal,IdFuncionario")] Consulta consulta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DataHora,Descricao,IdAnimal,IdFuncionario")] Consulta consulta)
        {
            if (id != consulta.Id)
            {
                return NotFound();
